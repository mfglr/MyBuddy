...
{
    internal class SetPostContentModerationResultPostService(IMapper mapper, IPublishEndpoint publishEndpoint, IMediator mediator) : IConsumer<PostContentClassifiedEvent>
    {
