...
using CommentQueryService.Worker.MassTransit.Consumers.UpsertUser_OnAccountMediaCreated;
...
using CommentQueryService.Worker.MassTransit.Consumers.UpsertUser_OnAccountUserNameUpdated;
using MassTransit;
            ...
            return services
                ...
                .AddMassTransit(
                    x =>
                    {
                        ...
                        x.AddConsumer<UpsertUser_OnAccountMediaCreated_CommentQueryService>();
