...
namespace AuthServer.Infrastructure.Migrations
{
    ...
    [Migration("20260425035228_RemoveIsDeletedAndDeletedAdColumns")]
    partial class RemoveIsDeletedAndDeletedAdColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthServer.Domain.Account", b =>
                {
                    ...
                    b.Property<IReadOnlyList<AccountMedia>>("Media")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AuthServer.Domain.Account", null)
                        .WithMany()
