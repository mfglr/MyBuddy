...
{
    internal class UpgradePostLiked_OnPostDisliked_PostLikeQueryService(ISender sender, UpgradePostLike_OnPostDisliked_Mapper mapper) : IConsumer<PostDislikedEvent>
    {
